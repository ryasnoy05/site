...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20191109_examples_c109913058ad98a13443_20191109152038_archive.zip';
	const ARCHIVE_SIZE		 = '40926740';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'c109913-09152038';
	...
	public function run()
	{
		...
		self::log('==DUPLICATOR INSTALLER BOOTSTRAP v1.3.22==');
		self::log('----------------------------------------------------');
